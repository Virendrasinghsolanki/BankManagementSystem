...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        r2 = new JRadioButton("Fixed Deposit Accountt");
        ...
        JLabel carddetail = new JLabel("Yout 16-digit Card Number");
        ...
        JLabel pindetail = new JLabel("Yout 4-digit PIN");
        ...
        c7 = new JCheckBox("I here by declares that the above details are correct to the best of my knowledge");
